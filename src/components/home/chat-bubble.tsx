...
const ChatBubble = ({me,message,prevMessage}:ChatBubbleType) => {
	...
	const bgColor = fromMe ? "bg-green-chat" : "bg-white dark:bg-gray-primary";
...
const SelfMessageIndicator = () => {
	return (
		<div className="absolute bg-green-chat top-0 -right-[3px] w-3 h-3 rounded-br-full"></div>
	)
}
		...
		<div>
			{isLink ? 
				<a
					...
					className={`mr-2 text-sm text-blue-400 underline font-light`}
				>{message.content}</a>
			:
